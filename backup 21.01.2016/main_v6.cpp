...
int main(int argc, char* argv[])
{
	...
	while (1){
		...
		data << dblToString(ballcd.x) + " " + dblToString(ballcd.y) + " " + dblToString(t) + " " + intToString(mycase) + " " + intToString(state.at<float>(0)) + " " + intToString(state.at<float>(1)) + " " + intToString(correct.at<float>(0)) + " " + intToString(correct.at<float>(1)) + "\n";// " " + BoolToString(objectDetected) + " " + intToString(mycase) + "\n";
		data.close();
