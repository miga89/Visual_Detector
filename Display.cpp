...
cv::Point_<double> vertical_left_top(125, 0);
cv::Point_<double> vertical_left_bottom(125, FRAME_HEIGHT);

cv::Point_<double> vertical_right_top(FRAME_WIDTH - 125, 0);
cv::Point_<double> vertical_right_bottom(FRAME_WIDTH - 125, FRAME_HEIGHT);

cv::Point_<double> horizontal_top_left(0, 125);
cv::Point_<double> horizontal_top_right(FRAME_WIDTH, 125);

cv::Point_<double> horizontal_bottom_left(0, FRAME_HEIGHT - 400);
cv::Point_<double> horizontal_bottom_right(FRAME_WIDTH, FRAME_HEIGHT - 400);
